...
public class RepositoryAdultToys implements IRepositoryAdultToys{
    ...
    @Override
    public boolean AddAdultToys(AdultToys adultToys) {
        Connection connection;
        try {
            connection = iManager.getConnection();
            PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO toys(name,price,manufacurer,quantity,department_of_toys) VALUES(?,?,?,?,3)");
